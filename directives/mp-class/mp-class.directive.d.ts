 ...
 * @publicApi
 */
export declare class MpClass implements DoCheck {
    ...
    set mpClass(value: string | Array<string> | Set<string> | {
        [klass: string]: any;
    });
    ngDoCheck(): void;
    ...
    static ɵfac: i0.ɵɵFactoryDef<MpClass, never>;
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<MpClass, "[mpClass]", never, { "klass": "class"; "mpClass": "mpClass"; }, {}, never>;
}
